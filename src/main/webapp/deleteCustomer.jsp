    ...
    %>
        ...
        <div class="customer-data">
            <div class="left-half">
                ...
                <b>Zip Code: </b><%=customer.getZipCode()%><br><br>    
            </div>

            <%
                ArrayList<Account> accounts = (ArrayList<Account>)request.getAttribute("accountList");
                boolean everyAccountClosed = allAccountsClosed(accounts);
            %>

            <%!
                boolean allAccountsClosed(ArrayList<Account> accounts) {
            ...
            %>
                ...
                <% } %>
                <form method="post" action="DeleteCustomer" onsubmit="return giveWarning(<%=everyAccountClosed%>)" class="delete-customer">
                <input type="hidden" name="id" value="<%=customer.getCustomerId()%>" required/>
                    <span><a href="./executivehome"><button type="button">Cancel</button></a>
                    <input type="submit" value="Delete" onSubmit="validate()"></span>
                </form>
            </div>
        </div>
    <%}%>
